      ...
      <section className="border-b border-border">
        <div ref={aboutRef} className="fade-in-section mx-auto max-w-4xl px-6 py-20">
          ...
          <div className="mt-8 space-y-5 text-base leading-relaxed text-muted-foreground">
            <p>
  I’m grounded in strong fundamentals across operating systems and computer networks, with a clear
  understanding of how large-scale systems behave under real-world constraints. I think about
  performance, scalability, and reliability before writing code.
</p>
<p>
  Beyond engineering, I care deeply about product: what features matter, why they matter, and how to
  ship them with intent. I proactively take ownership of my work and contribute to open source,
  because the best way to learn is to build in the open.
</p>
<p className="text-foreground/70 italic">
  I’m also an avid F1 fan and always up for discussions on how Ferrari could improve race
  strategy haha!
</p>
